...
class RateAlertScreen2 extends ConsumerStatefulWidget {
  const RateAlertScreen2({super.key});

  @override
  ConsumerState<RateAlertScreen2> createState() => _RateAlertScreen2State();
}

class _RateAlertScreen2State extends ConsumerState<RateAlertScreen2>
